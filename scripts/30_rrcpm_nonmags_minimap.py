...
Purpose = "Purpose: to find relative abundance of contigs from MAGs, Individual Assemblies, and Co-assembly from minimap sam file."
...
parser.add_argument("-ref", "--ref", help = "mapping reference (assembly that reads are mapped to)")
...
# subwkdir = wkdir
# # aln_dir = f'{subwkdir}/MINIMAP_ERR6088243'
# # ref = 'ERR6088243'
# ref = 'coassembly'
# aln_dir = f'{subwkdir}/MINIMAP_coassembly'
# CRISPRONE_CRT = f'{wkdir}/CRISPRONE/rNA'
# abund_dir = f'{wkdir}/CONTIG_RELATIVE_ABUNDANCE'
# out = f'{wkdir}/CONTIG_RELATIVE_ABUNDANCE/relative_contig_abundance_profiles_crt_ERR6088243_minimap.tsv'
...
for assembly in assemblies:
    if assembly2crt_count.get(assembly) != None:
        ...
        if os.stat(path_crt).st_size != 0 and 'bin' not in assembly:
            contig2crt_tmp = {}
